...
const CLASS_CONFIGS = {
  guerreira: {
    ...
    attackDamage: 15, attackCooldown: 120, specialDamage: 25, specialStyle: "cenoura"
  },
  estrategista: {
    ...
    attackDamage: 12, attackCooldown: 180, specialDamage: 28, specialStyle: "marmita"
  },
  sereia: {
    ...
    attackDamage: 10, attackCooldown: 100, specialDamage: 25, specialStyle: "agua"
  }
};
...
class GameScene extends Phaser.Scene {
  ...
  addEnemy(type, x, y, hpOverride) {
    ...
    const D = {
      ...
      boss: { tex: "saudadeBoss", real: "fi_pizza", name: "🍕 Pizza Monstro da Saudade", hp: 6, sp: 74, dmg: 1, sc: 900, boss: true },
      maromba: { tex: "boss_maromba", real: null, name: "💪 Marombeiro da Saudade", hp: 5, sp: 84, dmg: 1, sc: 700, boss: true }
    }[type];
    if (!D) return null;
